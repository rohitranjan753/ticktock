...
void main() {
  group('TickTock Clock Picker Tests', () {
    testWidgets('TimeScrollPicker renders correctly', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(body: TickTock(initialTime: initialTime)),
        ),
      );
    ...
    testWidgets('TimeScrollPicker with 24-hour format', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: TickTock(initialTime: initialTime, style: customStyle),
          ),
        ),
      );
    ...
    group('Time Validation Tests', () {
      testWidgets('TimeScrollPicker handles edge cases', (
        WidgetTester tester,
      ) async {
        // Test noon
        ...
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(body: TickTock(initialTime: noonTime)),
          ),
        );
